...
function _init() {
  ...
  regeneratorRuntime.mark(function _callee() {
    var moduleSub, instance;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./sub */ "./src/sub.js"));

          case 2:
            moduleSub = _context.sent;
            console.log("💗ES2020 - ダイナミックインポート");
            instance = new moduleSub.Hello();
