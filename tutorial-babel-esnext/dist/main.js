...
var instance = new _sub__WEBPACK_IMPORTED_MODULE_1__["Hello"]();
...
function () {
  ...
  _createClass(Hello, [{
    ...
    /** 非同期指定で呼び出します。 */
    value: function () {
      var _say = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(message) {
        var arr, numList, numList2, str, _numList, _loop, _i, _numList2, restParam, reDate, match, year, month, day, instance;
