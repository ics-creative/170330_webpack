...
// module
exports.push([module.i, "*{margin:0;padding:0}html body{background:url(" + escape(__webpack_require__(5)) + ");font-family:sans-serif}html body h1{filter:blur(4px);user-select:none;pointer-events:none;font-size:10vw;background:#fff}", "", {"version":3,"sources":["/Users/ics-ikeda/Documents/git/170330_webpack/tutorial-sass-postcss/style.scss"],"names":[],"mappings":"AAAA,EACE,SAAU,SACC,CAAE,UAGb,yCAA2B,sBACH,CAAE,aAExB,iBAAkB,iBACA,oBACG,eACO,eACV,CAAE","file":"style.scss","sourcesContent":["* {\n  margin: 0;\n  padding: 0; }\n\nhtml body {\n  background: url(thumb.jpg);\n  font-family: sans-serif; }\n  html body h1 {\n    filter: blur(4px);\n    user-select: none;\n    pointer-events: none;\n    font-size: calc(100vw / 10);\n    background: white; }\n"],"sourceRoot":""}]);
