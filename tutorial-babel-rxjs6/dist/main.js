...
(function (factory) {
  var root = (typeof __webpack_require__.g === "undefined" ? "undefined" : _typeof(__webpack_require__.g)) === "object" ? __webpack_require__.g : (typeof self === "undefined" ? "undefined" : _typeof(self)) === "object" ? self : _typeof(this) === "object" ? this : {};
...
var tslib = __webpack_require__(274);
var tslib_default = /*#__PURE__*/__webpack_require__.n(tslib);

// CONCATENATED MODULE: ../node_modules/tslib/modules/index.js

var __extends = (tslib_default()).__extends,
    __assign = (tslib_default()).__assign,
    __rest = (tslib_default()).__rest,
    __decorate = (tslib_default()).__decorate,
    __param = (tslib_default()).__param,
    __metadata = (tslib_default()).__metadata,
    __awaiter = (tslib_default()).__awaiter,
    __generator = (tslib_default()).__generator,
    __exportStar = (tslib_default()).__exportStar,
    __createBinding = (tslib_default()).__createBinding,
    __values = (tslib_default()).__values,
    __read = (tslib_default()).__read,
    __spread = (tslib_default()).__spread,
    __spreadArrays = (tslib_default()).__spreadArrays,
    __await = (tslib_default()).__await,
    __asyncGenerator = (tslib_default()).__asyncGenerator,
    __asyncDelegator = (tslib_default()).__asyncDelegator,
    __asyncValues = (tslib_default()).__asyncValues,
    __makeTemplateObject = (tslib_default()).__makeTemplateObject,
    __importStar = (tslib_default()).__importStar,
    __importDefault = (tslib_default()).__importDefault,
    __classPrivateFieldGet = (tslib_default()).__classPrivateFieldGet,
    __classPrivateFieldSet = (tslib_default()).__classPrivateFieldSet;
  ...
  function Subscriber(destinationOrNext, error, complete) {
    ...
    switch (arguments.length) {
      ...
      case 1:
        ...
        if (Subscriber_typeof(destinationOrNext) === 'object') {
